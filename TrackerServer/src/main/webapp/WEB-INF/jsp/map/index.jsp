...
<html>
  ...
  <body>
    <div id="main_wrapper">
        ...
        <div id="content">
          <p>
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin vel risus sit amet eros tempor aliquet. Maecenas semper pretium tincidunt. Donec ac lorem justo. Maecenas malesuada vehicula mi, nec pretium eros dictum eu. Donec non lectus volutpat dolor ullamcorper cursus. Etiam sollicitudin, turpis eu fermentum euismod, lacus leo viverra purus, ut gravida urna erat vitae lacus. Vestibulum pulvinar ultricies mi et molestie. Nullam vehicula, nulla ut pretium dapibus, enim augue tempor arcu, vitae mollis libero orci vel urna. Nullam eu augue sapien. Donec tristique pellentesque turpis, nec molestie orci aliquam vel. Ut dolor neque, tristique sed feugiat fringilla, vehicula id metus. Etiam lacinia, leo eget viverra porta, sapien mi viverra nulla, eget ultrices massa erat eget massa. Donec eget diam commodo est suscipit molestie. Etiam luctus quam ut sapien pretium nec tincidunt ante fermentum. Duis volutpat tincidunt orci, vitae tempor odio consectetur id.
	      </p>

		  <div id="map">
			
			<div id="mapCover" style="position: absolute; top: 0px; left: 0px; width: 600px; height: 400px; z-index: 10;"></div>			
			<!-- 
    ...
    <script>
			...
			function onBodyLoad() {
				...
				$("#mapCover").mouseout(function(e) { onMouseRelease(e); });
